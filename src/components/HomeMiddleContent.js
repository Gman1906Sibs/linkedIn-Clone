...
function HomeMiddleContent(props) {
                ...
                <p>There are no articles</p>
                    ...
                    <div className="content">
                        { 
                            props.loading && 
                                <img 
                                    className="content__loadingIMG" 
                                    src="https://printbroking.com/assets/images/loader.gif" 
                                />
                        }
...
export default connect(mapStateToProps, mapDispatchToProps)(HomeMiddleContent);
